...
{define list→名
  {match-lambda
    ...
    [(or (list 甲 ..1 #\→ 乙 ..1) (list 甲 ..1 #\- #\> 乙 ..1))
     (→名/構 '一 (list
               (→構 類/化 `(,(→構 類/列/連 `(,(list→type 甲) ,類/列/空:類)) ,(list→type 乙)))
               '其))]
