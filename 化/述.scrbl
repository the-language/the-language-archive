...
@述值[!引 :式？ #:value (→式 (→化 '(:表 :物) ':物))]

@subsubsection{陰-陽}
@述值[其:陰 :陰？]
@述值[其:陽 :陽？]
@述化[(陰-陽.若 [:物 陰-陽？] [甲 :物？] [乙 :物？]) :物？]{若@語[:陰-陽/陽]是@語[陽]，則返回@語[乙]，否則返回@語[丙]。}
...
@述化[(:表？ [:物 (非 :誤？)]) :陰-陽？]
@述值[空:表 :表？]
@述化[(表.增 [:物 :表？] [名 :物？] [:物 :物？]) :表？]{原來沒有，是增。}
@述化[(表.改 [:物 :表？] [名 :物？] [:化 (-> :物？ :物？)]) :表？]
@述化[(表.取 [:物 :表？] [名 :物？]) :物？]
@述化[(表.含？ [:物 :表？] [名 :物？]) :陰-陽？]
@述化[(表.删 [:物 :表？] [名 :物？]) :表？]{必須有，才能刪。}
@述化[(表→列 [:物 :表？]) (listof (list/c any/c any/c))]

@subsubsection{集}
@述化[(:集？ [:物 (非 :誤？)]) :陰-陽？]
@述值[空:集 :集？]
@述化[(集.增 [:物 :集？] [:物 :物？]) :集？]{原來沒有，是增。}
@述化[(集.含？ [:物 :集？] [:物 :物？]) :陰-陽？]
@述化[(集.删 [:物 :集？] [:物 :物？]) :集？]{必須有，才能刪。}
@述化[(集→列 [:物 :集？]) (listof any/c)]
